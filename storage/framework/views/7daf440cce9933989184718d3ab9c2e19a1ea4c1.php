<!-- ========= NAVBAR ============ -->
  ...
  <div class="container"> 
    ...
    <div class="collapse navbar-collapse " id="navbarNavAltMarkup">
      <ul class="navbar-nav ms-auto gap-1" style="text-align:right">
        ...
        <li class="nav-item">
          <a class="nav-link <?php echo e(($title==="Posts")? 'active': ''); ?>"" href="/transaksiAktif">Transaksi</a>
        </li>
  ...
  <!-- =============== END OF NAVBAR ============== --><?php /**PATH C:\Users\rezaa\Documents\DEVELOPMENT\Dewi_Laundry\resources\views/layouts/web/navbar.blade.php ENDPATH**/ ?>