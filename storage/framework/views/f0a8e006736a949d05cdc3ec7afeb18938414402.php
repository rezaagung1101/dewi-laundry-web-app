    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse " id="navbarNavAltMarkup">
            <ul class="navbar-nav ms-auto gap-1" style="text-align:right">
                ...
                <li class="nav-item">
                    <a class="nav-link <?php echo e(($title==="Cek Estimasi")? 'active': ''); ?>"" href=" /cekEstimasi">Cek
                        Estimasi</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link <?php echo e(($title==="Masuk")? 'active': ''); ?>"" href=" /login">Masuk</a>
                </li>
            </ul>
        </div>
    </div>
</nav>
<!-- =============== END OF NAVBAR ============== --><?php /**PATH C:\Users\rezaa\Documents\DEVELOPMENT\Dewi_Laundry\resources\views/templates/navbarPengunjung.blade.php ENDPATH**/ ?>